/* [Usage]
 ...
 >                                                                   log('processing...', {newLine:false});
 >                                                                   log('done.', {newLine:false});
 >                                                                   log('newLogMsg');
...
function __log(context, msg, option) {
  ...
  if (option && option.newLine === false) {
 ...
 * @returns function log(msg, option {newLine:<Boolean>, head:<String>, stderr:<Boolean>}). See __log
 */
function create(filePath, keepOldFileDays) {
  var context = {filePath: filePath, keepOldFileDays: keepOldFileDays, fd: -1, isAutoAppendNewLineMode: true, previousLineHaveEnded: true};
