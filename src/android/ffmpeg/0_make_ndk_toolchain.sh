...
ls -d ../../ndk_toolchain && { echo ../../ndk_toolchain already exist; exit 0; }
...
$ANDROID_NDK_ROOT/build/tools/make-standalone-toolchain.sh --install-dir=../../ndk_toolchain --platform=$PLATFORM --toolchain=$TOOLCHAIN --system=$WORK_SYSTEM --arch=arm --verbose
